...
<div id="line-one">
  <div class="container">
    ...
    <div class="row">  
      <br>
      <h4 id="center" style='text-align: center;'><b>CADASTRO DOS DADOS DO CURSO</b></h4>
      <br>              
    </div>
        ...
        <form method="POST" action="{{ route('curso.store')}}">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="text" name='nomecurso' class="form-control" placeholder="">
            </div>
            <div class="col-md-3">
              <label><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Valor:</font></font></label>
              <input type="text" name='valorcurso' class="form-control" placeholder="">
            </div>
          </div>
