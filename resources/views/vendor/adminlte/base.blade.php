...
@section('body')
    <div class="wrapper">
        ...
        <div class="col-md-6" style='position: absolute; top: 15%; left:34%;'>
        <div class="col-md-5 col-xs-6" style='border-radius: 10px'>
          ...
          <div class="small-box bg-aqua" style='width: auto; border-radius: 10px';>
            ...
            <a href="#" class="small-box-footer"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Mais informações </font></font><i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-md-5 col-xs-6" style='border-radius: 10px'>
