...
//function editarAluno(cdaluno){

  //  $.get("/aluno/"+cdaluno +"/edit", function(data, status){
        // alert("Data: " + data + "\nStatus: " + status);
    ...
    // $('#edit').open('click', function (event) {
    //     console.log("okokokok")
    //     var button = $(event.relatedTarget) 
    //     var nmatricula = button.data('mynmatricula') 
    //     var nome = button.data('mynome') 
    //     var val_id = button.data('valid') 
    //     var modal = $(this)
    //     modal.find('.modal-body #nmatricula').val(nmatricula)
