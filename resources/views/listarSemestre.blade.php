...
<div id="line-one">
  <div class="container">
    ...
    <div class="row">  
      <br>
      <h4 id="center" style='text-align: center;'><b>LISTA DOS SEMESTRES CADASTRADOS</b></h4>
      <br>              
    </div>
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <a href="{{route('semestre.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Cadastrar</a>     
              </button>
              <form action="{{route('semestre.search')}}" method="POST" class="form form-inline pull-right">
                {!! csrf_field() !!}
              ...
              <table class="table table-hover">
                ...
                @foreach($listSemestre as $value)
                    <tr>
                        ...
                        <th><a href="{{route('semestre.edit', $value->cdsemestre)}}" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
                        </th>
                    </tr>
                @endforeach
