...
<div id="line-one">
  <div class="container">
    ...
    <div class="row">  
      <br>
      <h4 id="center" style='text-align: center;'><b>CADASTRO DOS DADOS DO SEMESTRE</b></h4>
      <br>              
    </div>
    ...
    <div class="box box-primary">
      ...
      @endif
        <form method="POST" action="{{ route('semestre.store')}}">
          ...
          <div class="row">
            <div class="col-md-5">
              <label><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ano:</font></font></label>
