...
<div id="line-one">
  <div class="container">
    ...
    <div class="row">  
      <br>
      <h4 id="center" style='text-align: center;'><b>LISTA DAS TURMAS CADASTRADAS</b></h4>
      <br>              
    </div>
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <a href="{{route('turma.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Cadastrar</a>     
              </button>
              <form action="{{route('turma.search')}}" method="POST" class="form form-inline pull-right">
                {!! csrf_field() !!}
                <input type="text" name="nometurma" class="form-control" placeholder="Nome Turma">
              ...
              <table class="table table-hover">
                ...
                @foreach($listTurma as $value)
                    <tr>
                        ...
                        <th><a href="{{route('turma.edit', $value->cdturma)}}" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
                        </th>
                    </tr>
                @endforeach
